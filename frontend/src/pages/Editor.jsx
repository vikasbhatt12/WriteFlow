      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
            ...
            <textarea
              className="w-full h-[calc(100vh-300px)] p-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 dark:border-gray-600"
              value={markdown}
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
            ...
            <div className="prose max-w-none h-[calc(100vh-300px)] overflow-auto dark:prose-invert">
              <ReactMarkdown 
